...
<div className='w-full bg-black text-white text-center'>
    <div className='max-w-[1240px] mx-auto px-4 py-16 '>
        ...
        <div>
            <h1 className='py-4 text-2xl'>A Growing Protocol Ecosystem</h1>
            <p className='py-4 text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi, libero. 
                Voluptatem et illo facilis aperiam laborum in aliquid
                 cumque neque eveniet error est reprehenderit odio, debitis labore 
                 quae laudantium veniam.</p>
            ...
            text='Integrate pre-built, time-tested oracle solutions that already 
            ...
            text='Build on a flexible framework that can retrieve data from any API,
            ...
            text='Use a decentralized network of DeFi Keeper nodes to automate 
            contracts, mitigating risk of manual interventions and 
            centralized servers.' />
